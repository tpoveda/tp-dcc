...
class ContainerAsset(DGNode):
    ...
    def delete(self, remove_container: bool = True):
        ...
        :param remove_container: If True, then the container will be deleted, otherwise only members will be removed.
        """
    ...
    def blackBox(self, flag):
        ...
        :param flag: True if the contents of the container are not public; False otherwise.
        """
