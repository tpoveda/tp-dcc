...
#include "../Public/tpAdvancedDeletion.h"
...
void SAdvanceDeletionTab::OnComboBoxSelectionChanged(TSharedPtr<FString> SelectedOption, ESelectInfo::Type SelectInfo)
{
	...
	FtpAdvancedDeletionModule& tpUnrealModule = FModuleManager::LoadModuleChecked<FtpAdvancedDeletionModule>(TEXT("tpUnreal"));
...
FReply SAdvanceDeletionTab::OnDeleteAllButtonClicked()
{
	...
	FtpAdvancedDeletionModule& tpUnrealModule = FModuleManager::LoadModuleChecked<FtpAdvancedDeletionModule>(TEXT("tpAdvancedDeletionModule"));
