...
from tp.common.python import helpers, profiler, yamlio
from tp.maya.meta import base

from tp.libs.rig.crit import consts
from tp.libs.rig.crit.core import errors
from tp.libs.rig.crit.maya.core import config, rig, template as core_template
...
def load_rig_from_template(
	...
	if rig_to_use is None:
		...
		rig_config = config.MayaConfiguration()
