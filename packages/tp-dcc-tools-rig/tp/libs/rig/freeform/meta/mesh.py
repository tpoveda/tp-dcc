...
class FreeformMeshes(base.DependentNode):

	ID = consts.MESHES_TYPE
	...
	def setup(self, group_name: str, character_group: api.DagNode):
		self.create_transform(group_name, parent=character_group)
