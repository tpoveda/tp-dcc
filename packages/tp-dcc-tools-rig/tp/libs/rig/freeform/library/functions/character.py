...
from tp.libs.rig.freeform.meta import character, mesh, rig as meta_rig, skeleton as meta_skeleton
...
def delete_character(character_node: character.FreeformCharacter, move_namespace: str | None = None):
	"""
	...
	character_node = base.create_meta_node_from_node(character_node)
	character_group = character_node.root_transform()
