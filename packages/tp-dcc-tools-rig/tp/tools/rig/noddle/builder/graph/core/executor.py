...
if typing.TYPE_CHECKING:
    ...
    from tp.tools.rig.noddle.builder.graph.nodes.node_graph_inout import GraphInputNode
...
class GraphExecutor:
    ...
    def find_input_node(self) -> GraphInputNode | None:
        ...
        input_nodes = [node for node in self.scene.nodes if node.ID == 101]         # type: list[GraphInputNode]
        if not input_nodes:
