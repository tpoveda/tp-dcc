...
if typing.TYPE_CHECKING:
    from tp.tools.rig.noddle.builder.graph.graphics.edge import GraphicsEdge
    from tp.tools.rig.noddle.builder.graph.graphics.slicer import Slicer, FreehandSlicer
