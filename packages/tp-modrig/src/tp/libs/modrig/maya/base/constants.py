...
MODULES_ENV_VAR_KEY = "TP_MODRIG_MODULES_PATHS"
DESCRIPTORS_ENV_VAR_KEY = "TP_MODRIG_DESCRIPTORS_PATHS"
TEMPLATES_ENV_VAR_KEY = "TP_MODRIG_TEMPLATES_PATHS"
GRAPHS_ENV_VAR_KEY = "TP_MODRIG_GRAPHS_PATHS"
