...
def create_decompose(
    ...
    if destination:
        ...
        decompose.outputRotate.connect(
            destination.attribute("rotate"), children=rotation_values
        )
        decompose.outputScale.connect(
            destination.attribute("scale"), children=scale_values
        )
