...
Usage (PowerShell):
    & "C:\\Program Files\\Autodesk\\Maya2026\\bin\\mayapy.exe" run_maya_tests.py [pytest arguments]

Examples:
    & "C:\\Program Files\\Autodesk\\Maya2026\\bin\\mayapy.exe" run_maya_tests.py                           # Run all tests
    & "C:\\Program Files\\Autodesk\\Maya2026\\bin\\mayapy.exe" run_maya_tests.py -m integration            # Run integration tests
    & "C:\\Program Files\\Autodesk\\Maya2026\\bin\\mayapy.exe" run_maya_tests.py -m "not integration"      # Run unit tests only
    & "C:\\Program Files\\Autodesk\\Maya2026\\bin\\mayapy.exe" run_maya_tests.py -v                        # Verbose output
    & "C:\\Program Files\\Autodesk\\Maya2026\\bin\\mayapy.exe" run_maya_tests.py --cov=tp.libs.maya.meta   # With coverage
"""
...
def setup_environment():
    ...
    # scripts/run_maya_tests.py -> tp-maya -> packages -> tp-dcc
...
def main():
    ...
    print("=" * 60)
    print("Maya Integration Test Runner")
    print("=" * 60)
