...
class PreferencesManager(object):
	...
	def default_preference_path(cls):
		...
		:return: preferences absolute path. eg. ~/tpdcc_preferences
		:rtype: str
		"""
	...
	def prefs_path(cls):
		...
		:return: preferences absolute path. eg. ~/tpdcc_preferences/prefs
		:rtype: str
		"""
	...
	def asset_path(cls):
		...
		:return: assets absolute path. eg. ~/tpdcc_preferences/assets
		:rtype: str
		"""
	...
	def _resolve_interfaces(self, package=None):
		"""
		Internal function that resolves all the preference interfaces found in the tpdcc_preferences folder within each
