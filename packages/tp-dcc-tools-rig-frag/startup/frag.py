...
from tp.bootstrap.core import package
...
def startup(_: package.Package):
    ...
    logger.info('Loading tp-dcc-tools-rig-frag package...')
    ...
    resources.register_resource(resources_path, key='tp-dcc-tools-rig-frag')
...
def shutdown(bootstrap_package: package.Package):
    ...
    logger.info('Shutting down tp-dcc-tools-rig-frag package...')
