"""Naming API for tp.libs.templating.naming.

This module provides the public API for the naming functionality.
"""
...
from tp.libs.templating.naming.preset import PresetsManager
