...
from tp.libs.rig.noddle.maya.functions import naming
...
class Component(base.MetaBase):
    ...
    def component_name(self) -> str:
        """
        Returns this component base name from name.

        :return: component base name.
        :rtype: str
        """
        return naming.deconstruct_name(self.fullPathName(partial_name=True, include_namespace=False)).name

    def side(self) -> str:
        """
        Returns this component side from name.

        :return: component side.
        :rtype: str
        """

        return naming.deconstruct_name(self.fullPathName(partial_name=True, include_namespace=False)).side

    def index(self) -> str:
        """
        Returns this component index from name.

        :return: component index.
        :rtype: str
        """

        return naming.deconstruct_name(self.fullPathName(partial_name=True, include_namespace=False)).index

    def indexed_name(self) -> str:
        """
        Returns this component indexed name from name.

        :return: component indexed name.
        :rtype: str
        """

        return naming.deconstruct_name(self.fullPathName(partial_name=True, include_namespace=False)).indexed_name

    def suffix(self) -> str:
        """
        Returns this component suffix from name.
