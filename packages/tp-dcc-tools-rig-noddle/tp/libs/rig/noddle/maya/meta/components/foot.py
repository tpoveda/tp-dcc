...
class ReverseFootComponent(animcomponent.AnimComponent):
    ...
    def setup(
        ...
        toe_locator: api.DagNode | None = None
        inner_locator: api.DagNode | None = None
        outer_locator: api.DagNode | None = None
        heel_locator: api.DagNode | None = None
        ...
        toe_tap_transform = nodes.create(
            'transform', name=[self.indexed_name(), 'tap'], side=self.side(), suffix='grp',
            p=rv_chain[2].fullPathName())
